...
In this project, you will work only with fully-connected neural networks (FCNN). Those
...
You can work in Jupyter Notebooks. The notebooks should be well-formatted. You need
